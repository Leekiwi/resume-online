let resume = `# 李兵
137xxxxxxxx | Leekiwi@foxmail.com | 上海
Profile: https://Leekiwi.github.io/resume/
Github: https://github.com/Leekiwi
Blog: https://Leekiwi.github.io
16届毕业生 | 前端开发工程师
...
- [源码链接](https://github.com/Leekiwi/resume-online/blob/master/main.js) | [预览链接](https://Leekiwi.github.io/resume-online/)
...
- React 版本：[源码链接](https://github.com/Leekiwi/todo-react) | [预览链接](https://Leekiwi.github.io/todo-react/build/)
...
- [源码链接](https://github.com/Leekiwi/resume) | [预览链接](https://Leekiwi.github.io/resume/)

### 幻灯片放映室
- 关键词：\`jQuery\`、\`Loop模式\`、\`缩略图模式\`、\`Rem\`、\`适配移动端\`、\`ES6\`
- 描述：本项目展示了两种不同风格的轮播，功能有上一张、下一张、可点击的原点/缩略图导航、自动循环播放。使用了 Rem 单位，以及适配移动端。
- [源码链接](https://github.com/Leekiwi/Slides/blob/master/main.js) | [预览链接](https://Leekiwi.github.io/Slides/)

### 彩色涂鸦
- 关键词：\`HTML5\`、\`Canvas\`、\`ES6\`、\`JavaScript\`
- 描述：使用 HTML5 的 Canvas 元素及其相关 API ，实现支持多指同时画图（可选色/粗细）、橡皮擦、一键清空、保存至本地的功能。
- [源码链接](https://github.com/Leekiwi/Canvas/blob/master/main.js) | [预览链接](https://Leekiwi.github.io/Canvas/)
...
- [源码链接](https://github.com/Leekiwi/IMsystem) | [预览链接](https://arcane-mountain-17783.herokuapp.com/)
